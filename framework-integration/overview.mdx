...
<CardGroup cols={3}>
  <Card title="Django" icon="python" href="/integrations/django">
    Full-featured web framework with ORM and admin interface
  </Card>
  <Card title="FastAPI" icon="bolt" href="/integrations/fastapi">
    Modern, fast framework with automatic API documentation
  </Card>
  <Card title="Flask" icon="flask" href="/integrations/flask">
