...
<CardGroup cols={3}>
  <Card title="Django Setup" icon="python" href="/integrations/django">
    Set up ATP with Django
  </Card>
  <Card title="FastAPI Setup" icon="bolt" href="/integrations/fastapi">
    Set up ATP with FastAPI
  </Card>
  <Card title="Flask Setup" icon="flask" href="/integrations/flask">
