...
- **WebSocket connection** to the ATP server
...
<ParamField path="api_key" type="string" required>
  Your ATP API key. Get it from the [ATP Dashboard](https://chatatp-backend.onrender.com).
</ParamField>
...
<ParamField path="base_url" type="string" default="https://chatatp-backend.onrender.com">
