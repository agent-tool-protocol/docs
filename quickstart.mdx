...
<CardGroup cols={2}>
  <Card title="ToolKitClient Reference" icon="book" href="/build-with-atp/toolkit-client">
    Learn about all ToolKitClient methods and options
  </Card>
  <Card title="LLMClient Integration" icon="robot" href="/build-with-atp/llm-client">
