...
<Note>
  Get your Toolkit API key from the [ATP Dashboard](https://developers.chat-atp.com/signin).
</Note>
...
<CardGroup cols={2}>
  <Card title="ToolKitClient Reference" icon="book" href="/building-with-atp/toolkit-client">
    Learn about all ToolKitClient methods and options
  </Card>
  <Card title="LLMClient Integration" icon="robot" href="/building-with-atp/llm-client">
