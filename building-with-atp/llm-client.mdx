...
<ParamField path="api_key" type="string" required>
  Your ATP API key. Get it from the [ChatATP Developer Platform](https://developers.chat-atp.com).
</ParamField>
...
<ParamField path="base_url" type="string" default="https://api.chat-atp.com/ws/v1/atp/llm-client/">
...
<ParamField path="tool_calls" type="string | dict" required>
