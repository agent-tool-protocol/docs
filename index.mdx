...
<CardGroup cols={2}>
  ...
  <Card title="Connect LLMs with LLMClient" icon="robot" href="/build-with-atp/llm-client">
...
<CardGroup cols={2}>
  <Card title="ToolKitClient" icon="box" href="/build-with-atp/toolkit-client">
    Register and serve Python functions as tools
  </Card>
  <Card title="LLMClient" icon="brain" href="/build-with-atp/llm-client">
...
- [Bug Reports & Feature Requests](https://github.com/sam-14uel/Agent-Tool-Protocol/issues)
- [GitHub Discussions](https://github.com/sam-14uel/Agent-Tool-Protocol/discussions)
...
MIT License. See [LICENSE](https://github.com/sam-14uel/Agent-Tool-Protocol/blob/main/LICENSE) for details.