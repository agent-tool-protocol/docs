...
<CardGroup cols={2}>
  ...
  <Card title="Connect LLMs with LLMClient" icon="robot" href="/sdk/llm-client">
...
<CardGroup cols={2}>
  <Card title="ToolKitClient" icon="box" href="/sdk/toolkit-client">
    Register and serve Python functions as tools
  </Card>
  <Card title="LLMClient" icon="brain" href="/sdk/llm-client">
